...
public class FizzBuzzSolution {
    ...
    public String fizzBuzz(Integer number) {
        ...
        if((number % 3 ==0 || temp.contains("3")) && (number % 5 ==0 || temp.contains("5"))&&(((number % 3 ==0 && temp.contains("3")) || (number % 5 ==0 && temp.contains("5")))&&number%2!=0)) return  "fizz buzz fake deluxe";
        else if ((number % 3 ==0 || temp.contains("3"))&&(((number % 3 ==0 && temp.contains("3")) || (number % 5 ==0 && temp.contains("5")))&&number%2!=0)) return "fizz fake deluxe";
        else if ((number % 5 ==0 || temp.contains("5"))&&(((number % 3 ==0 && temp.contains("3")) || (number % 5 ==0 && temp.contains("5")))&&number%2!=0)) return "buzz fake deluxe";
        else if ((((number % 3 ==0 && temp.contains("3")) || (number % 5 ==0 && temp.contains("5")))&&number%2!=0)) return "fake deluxe";
